...
import com.newtonwilliamsdesign.potlatch.integration.test.UnsafeHttpsClient;
...
public class AutoGrading {
	...
	public static void main(String[] args) throws Exception {
		...
		File f = new File("./src/main/java/com/newtonwilliamsdesign/potlatch/gift/Application.java");
		if (!f.exists()) {
			System.out
					.println(WordUtils
